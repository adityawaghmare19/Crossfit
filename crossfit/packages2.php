...
<html>
    ...
    <body>
       <div class="banner20">
        ...
        <div class="text10" > <!--card-->
          <p>Calisthenics</p>
          <BR>
          <P>The Calisthenics refers to the training type that includes working out and lifting weight , unlike the calesthenic where only body weight is used for training</P>
              ...
              <div class="main_container">
                   <div class="slideshow-container">
                     ...
                     <div class="mySlides fade">
                       <img src="img/calen3.webp" style="width:500px"  >

                     </div>
                     <!--second img  -->
                     <div class="mySlides fade">
                       <img src="img/calens2.jpg" width="500px" height="323px"  >
         
                     </div>
                     <!--third img  -->
                     <div class="mySlides fade">
                       <img src="img/calens1.jpg" style="width:500px">
         
                     </div>

                     <!--fourth img  -->
                     <div class="mySlides fade">
                        <img src="img/calens4.webp" style="width:500px">
    ...
    <p class="info">Calisthenics is a type of strength training that uses body weights for resistance. 
      This could be done without any special equipment or dumbbells at home or a gym. 
      It stresses and strengthens your muscles over time to grow
    <pre class="info2">Calisthenics also improves:
 ...
 <br>
  <div class="text10" > <!--card-->
          ...
          <P>Start your Calisthenics Training Program !!</P>
</div>
